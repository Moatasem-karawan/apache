...
class ReadDataController extends Controller
{
    public function get_by_id_number(Request $request){
        ...
        $message=[
            ...
            "id_number.digits"=>"رقم الهوية يجب ان يتكون من 9 ارقام",
        ];
        ...
        if ($validator->fails()){
            ...
            if (is_null($response["psarchive"] ) ){
                ...
                return response()->json(["status"=>true,"status_code"=>200,"message"=>"return single array",'data'=>new handel_id_number($response["psarchive"][0])]);}
        }}
    public function get_by_full_name(Request $request){
        ...
        if ($validator->fails()){
            ...
            if (is_null($response["psarchive"] ) ){
                ...
                return response()->json(["status"=>true,"status_code"=>200,"message"=>"return  multiple array",'data'=>handel_name::collection($response["psarchive"])]);}
        }}
